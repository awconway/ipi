...
It is possible that clinical interventions taken in response to alarms in the Integrated Pulmonary Index group mediated the reduction in severity of oxygen desaturation events, which potentially signals a safety benefit for using this approach for capnography alarm management. Further research is needed to evaluate this potentially beneficial impact on patient safety.
