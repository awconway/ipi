...
author:
  - name: Aaron Conway
    affiliations: QUT School of Nursing, Peter Munk Cardiac Centre, UHN & University of Toronto
...
## Normal capnography waveform {.center}
...
## Alarm fatigue is a well-recognized problem in healthcare { style="text-align: center"}

- over-abundance of false or un-actionable alarms
- desensitises healthcare providers to alarms
- changes response patterns and alters alarm management (e.g. silencing or switching off alarms)
...
<iframe width="560" height="315" src="https://www.youtube-nocookie.com/embed/YHPU2uBKlz0?si=3qXsIor_Aczdet-I" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
- Primary outcome was a *count* of the number of seconds in an alarm 'state' over a procedure so we used a mixed effects negative binomial model (incidence rate ratio)
- Outcomes scored as zero if a patient did not have any alarms during the procedure
- Used models that accounted for the large number of zero scores
- 'zero-inflated' negative binomial model (for count outcomes) and hurdle lognormal model (for continuous outcomes)
...
- Imprecise (incidence rate of enabled could be as high as three times that of the disabled group) 
...
- Imprecision is a concern, arising from the fact that:
...
## The cluster design (by nurses) was an efficient way to conduct this study {.center}
